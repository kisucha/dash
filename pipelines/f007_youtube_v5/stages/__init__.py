# pipelines/f007_youtube_v5/stages/__init__.py
# 목적: F007 스테이지 공통 인터페이스 - BaseStage, ValidationResult 정의.
...
class ValidationResult:
    ...
    rejection_target: 반송할 스테이지 ID (예: STAGE_01_TOPIC)
...
class BaseStage:
    """F007 스테이지 추상 베이스 클래스.

    하위 클래스(Stage01Topic 등)가 반드시 구현해야 하는 메서드:
    ...
    BasePipeline을 함께 상속하여 직접 사용한다.
    """

    # 하위 클래스에서 반드시 재정의할 상수
    STAGE_ID: str = ""       # 예: "STAGE_01_TOPIC"
