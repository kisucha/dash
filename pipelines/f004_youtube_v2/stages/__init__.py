# 목적: F004 스테이지 공통 인터페이스 — BaseStage, ValidationResult 정의.
...
class ValidationResult:
    ...
    rejection_target: 반송할 스테이지 ID (예: STAGE_01_RESEARCH)
...
class BaseStage:
    """F004 스테이지 추상 베이스 클래스.

    하위 클래스(Stage01Research 등)가 반드시 구현해야 하는 메서드:
    ...
    STAGE_ID: str = ""       # 예: "STAGE_01_RESEARCH"
