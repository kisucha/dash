# 목적: F001 오케스트레이터 subprocess 진입점 — argv[1]=job_id.
# f001_service.create_job()에서 subprocess.Popen([sys.executable, this_file, str(job_id)])으로 호출된다.
...
from pipelines.f001_youtube.orchestrator import F001Orchestrator
